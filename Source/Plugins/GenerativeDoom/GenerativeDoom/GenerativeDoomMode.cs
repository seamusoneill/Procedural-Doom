...
namespace GenerativeDoom
{
    ...
    [EditMode(DisplayName = "GenerativeDoom",
              SwitchAction = "generativedoommode",
              ButtonImage = "GDIcon.png",
              ButtonOrder = 400,
    ...
    public class GenerativeDoomMode : ClassicMode
    {
        ...
        public override void OnEngage()
        {
            ...
            BuilderPlug.Me.GDForm.ShowWindow((Form)General.Interface);
        }
